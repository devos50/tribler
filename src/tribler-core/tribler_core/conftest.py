...
@pytest.fixture
def free_ports(bucket_range_port):
    """
    ...
    def get_ports(param):
        ...
        for _ in range(param):
            min_base_port, max_base_port = bucket_range_port
...
@pytest.fixture
def stream(mock_handle, test_download):
    test_download.handle.torrent_file.return_value.file_at.return_value = Mock(size=250)
    return Stream(test_download, 0)
