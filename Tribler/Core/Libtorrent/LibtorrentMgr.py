...
from Tribler.Core.Utilities.utilities import fix_torrent, parse_magnetlink, has_bep33_support
...
class LibtorrentMgr(TaskManager):
    ...
    def initialize(self):
        ...
        if has_bep33_support():
            self.get_session(0).set_alert_mask(self.default_alert_mask | lt.alert.category_t.dht_log_notification)
            self.dht_health_manager = DHTHealthManager(self.get_session(0))
