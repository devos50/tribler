...
class OrderManager(object):
    ...
    def create_ride_offer(self, latitude, longitude, quantity, timeout):
        ...
        order = Order(self.order_repository.next_identity(), latitude, longitude, quantity, timeout, Timestamp.now(), True)
    ...
    def create_ride_request(self, latitude, longitude, quantity, timeout):
        ...
        order = Order(self.order_repository.next_identity(), latitude, longitude, quantity, timeout, Timestamp.now(), False)
        self.order_repository.add(order)
