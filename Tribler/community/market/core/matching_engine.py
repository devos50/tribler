...
class MatchingStrategy(object):
    ...
    @abstractmethod
    def match(self, latitude, longitude, is_ask):
        """
...
class TaxiStrategy(MatchingStrategy):
    ...
    def match_ask(self, latitude, longitude):
        ...
        if min_tick:
            return [(MatchingStrategy.generate_match_id(), min_tick, Quantity(1, 'taxi'))]
        return []
...
class PriceTimeStrategy(MatchingStrategy):
    ...
    def _search_for_quantity_in_order_book_partial(self, order_id, price, price_level, quantity_to_trade, tick_price, is_ask):
        # Not all the quantity can be matched in this price level
    ...
    def _search_for_quantity_in_price_level_total(self, tick_entry, quantity_to_trade):
        ...
        return [(MatchingStrategy.generate_match_id(), tick_entry, trading_quantity)]
    ...
    def _search_for_quantity_in_price_level_partial(self, order_id, tick_entry, quantity_to_trade, tick_price, is_ask):
        ...
        if matched_quantity > Quantity(0, matched_quantity.wallet_id) and not \
            ...
            matching_ticks = [(MatchingStrategy.generate_match_id(), tick_entry, matched_quantity)]
...
class MatchingEngine(object):
    ...
    def match(self, tick_entry):
        ...
        matched_ticks = self.matching_strategy.match(tick_entry.tick.latitude, tick_entry.tick.longitude,
